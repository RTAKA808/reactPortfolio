...
const router=createBrowserRouter([{
  path:'/',
  element:<App/>,
  children:[{index:true, element:<AboutPage/>}, {path:'/portfolio', element:<PortfolioPage/>},{path:'/resume', element:<ResumePage/>}, {path:'/contact', element:<ContactPage/>}]
}])
/*
...
export function Computers(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenInteractive frame="Object_206" panel="Object_207" position={[0.27, 0, -.61]} scale={3.5} />
